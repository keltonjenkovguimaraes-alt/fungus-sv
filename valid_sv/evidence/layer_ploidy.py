...
def analyze_ploidy(vcf_path: str) -> PloidyEvidence:
    ...
    # - Hammond et al. (2025): HiFi SNP F1 >99.9% in non-difficult regions
    # - Dunn et al. (2024): 42.6% of apparent phasing flip errors are
    #   representation artifacts, not true heterozygosity
    # - Kronenberg et al. (2025): pedigree-consistent filtering removes
    #   false heterozygous calls in repetitive regions
    if het_rate < 0.03:
        is_haploid = True
        score = 1.0
